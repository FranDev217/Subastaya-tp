...
function SubastaCard({ subasta }) {
  const { dias, horas, minutos, segundos, finalizada } = useCountdown(subasta.fechaFin)
  ...
  return (
    <article className={`subasta-card ${obtenerClaseEstado()}`}>
      ...
      <div className="subasta-card__contenido">
        ...
        <span className="subasta-card__categoria">{subasta.categoriaNombre}</span>
        
        <div className="subasta-card__oferta">
          <span className="subasta-card__oferta-label">Oferta actual</span>
          <span className="subasta-card__oferta-monto">${subasta.ofertaActual.toLocaleString('es-AR')}</span>
        </div>
        ...
        <div className="subasta-card__info">
          ...
          <span className="subasta-card__tiempo">
            {formatearTiempo()}
          </span>
        </div>
      </div>
